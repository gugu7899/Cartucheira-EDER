...
public class MainActivity extends Activity {
    ...
    private void toggleLock(){locked=!locked;lockButton.setText(locked?"🔓 DESBLOQUEAR":"🔒 BLOQUEAR");lockButton.setBackground(shape(locked?accent:panel,1,locked?accent:0xff4a4d51,7));for(CartView c:carts)c.menu.setVisibility(locked?GONE:VISIBLE);}
